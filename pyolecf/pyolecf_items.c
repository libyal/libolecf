...
PyTypeObject pyolecf_items_type_object = {
	...
	/* tp_doc */
	"pyolecf sequence and iterator object of items",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
...
/* Creates a new items sequence and iterator object
...
PyObject *pyolecf_items_new(
           ...
           int number_of_items )
{
	pyolecf_items_t *sequence_object = NULL;
           ...
           Py_ssize_t item_index )
{
	...
	item_object = sequence_object->get_item_by_index(
