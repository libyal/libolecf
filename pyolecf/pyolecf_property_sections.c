...
PyTypeObject pyolecf_property_sections_type_object = {
	...
	/* tp_doc */
	"pyolecf sequence and iterator object of property sections",
	/* tp_traverse */
	0,
	/* tp_clear */
	0,
...
/* Creates a new property sections sequence and iterator object
...
PyObject *pyolecf_property_sections_new(
           ...
           int number_of_items )
{
	pyolecf_property_sections_t *sequence_object = NULL;
...
/* Initializes a property sections sequence and iterator object
     ...
     pyolecf_property_sections_t *sequence_object )
{
	...
	PyErr_Format(
	 ...
	 "%s: initialize of property sections not supported.",
	 function );

	return( -1 );
}

/* Frees a property sections sequence object
 */
           ...
           Py_ssize_t item_index )
{
	...
	property_section_object = sequence_object->get_item_by_index(
