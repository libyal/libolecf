...
#endif
{
	...
	if( option_extended_options != NULL )
	{
		...
		olecfmount_fuse_arguments.argc = 0;
		olecfmount_fuse_arguments.argv = NULL;
#endif
	...
	olecfmount_dokan_options.SingleThread = TRUE;
#else
...
*/
	...
	fprintf(
	 stderr,
	 "No sub system to mount Object Linking and Embedding (OLE) Compound File (CF) format.\n" );
