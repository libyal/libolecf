...
void (*olecftools_signal_signal_handler)( olecftools_signal_t ) = NULL;
             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( olecftools_signal_signal_handler != NULL )
			{
				olecftools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
 ...
 */
void olecftools_signal_initialize_memory_debug(
      void )
{
	int flag = 0;
 ...
 */
int olecftools_signal_attach(
     void (*signal_handler)( olecftools_signal_t ),
     libcerror_error_t **error )
{
	static char *function = "olecftools_signal_attach";
...
#if defined( _MSC_VER )
	olecftools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	olecftools_signal_signal_handler = NULL;
