...
#if !defined( _OLECFTOOLS_GETOPT_H )
#define _OLECFTOOLS_GETOPT_H
...
typedef struct olecftools_option olecftools_option_t;

struct olecftools_option
{
...
#define olecftools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t olecftools_getopt(
                  int argument_count,
...
void olecftools_getopt_wrapped_fprint(
      FILE *stream,
...
void olecftools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const olecftools_option_t *options,
      int number_of_options );

int olecftools_getopt_get_options_string(
     const olecftools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _OLECFTOOLS_GETOPT_H ) */
