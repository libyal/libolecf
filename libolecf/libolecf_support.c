...
#include "libolecf_libclocale.h"
#include "libolecf_io_handle.h"
#include "libolecf_support.h"
...
const char *libolecf_get_version(
             void )
{
	return( (const char *) LIBOLECF_VERSION_STRING );
}
...
uint8_t libolecf_get_access_flags_read(
         void )
{
	return( (uint8_t) LIBOLECF_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libolecf_get_codepage";
...
int libolecf_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libolecf_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libolecf_check_file_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libolecf_check_file_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libolecf_check_file_signature_file_io_handle";
