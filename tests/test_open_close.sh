...
{ 
	...
	${TEST_RUNNER} ./${OLECF_TEST_OPEN_CLOSE} ${INPUT_FILE};
...
OLECF_TEST_OPEN_CLOSE="olecf_test_open_close";

if ! test -x ${OLECF_TEST_OPEN_CLOSE};
then
	OLECF_TEST_OPEN_CLOSE="olecf_test_open_close.exe";
fi

if ! test -x ${OLECF_TEST_OPEN_CLOSE};
then
	echo "Missing executable: ${OLECF_TEST_OPEN_CLOSE}";
