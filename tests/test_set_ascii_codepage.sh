...
OLECF_TEST_SET_ASCII_CODEPAGE="olecf_test_set_ascii_codepage";

if ! test -x ${OLECF_TEST_SET_ASCII_CODEPAGE};
then
	OLECF_TEST_SET_ASCII_CODEPAGE="olecf_test_set_ascii_codepage.exe";
fi

if ! test -x ${OLECF_TEST_SET_ASCII_CODEPAGE};
then
	echo "Missing executable: ${OLECF_TEST_SET_ASCII_CODEPAGE}";
...
do
	...
	${TEST_RUNNER} ./${OLECF_TEST_SET_ASCII_CODEPAGE} ${CODEPAGE};
