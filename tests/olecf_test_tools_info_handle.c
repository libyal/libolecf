...
#include "../olecftools/info_handle.h"

/* Tests the info_handle_initialize function
 * Returns 1 if successful or 0 if not
 */
int olecf_test_tools_info_handle_initialize(
     void )
{
 ...
 * Returns 1 if successful or 0 if not
 */
int olecf_test_tools_info_handle_free(
     void )
{
	libcerror_error_t *error = NULL;
	int result               = 0;
...
#endif
{
	...
	OLECF_TEST_RUN(
	 ...
	 olecf_test_tools_info_handle_initialize );

	OLECF_TEST_RUN(
	 "info_handle_free",
	 olecf_test_tools_info_handle_free );
