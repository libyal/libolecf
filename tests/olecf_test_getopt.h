...
#if !defined( _OLECF_TEST_GETOPT_H )
#define _OLECF_TEST_GETOPT_H
...
#define olecf_test_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t olecf_test_getopt(
                  int argument_count,
...
#endif /* !defined( _OLECF_TEST_GETOPT_H ) */
