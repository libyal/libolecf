...
$LibraryTests = "allocation_table directory_entry error file_header io_handle item notify property_section property_set property_value"
...
Function RunTest
{
	...
	$TestExecutable = "${TestExecutablesDirectory}\olecf_test_${TestName}.exe"
...
Function RunTestWithInput
{
	...
	$TestProfileDirectory = GetTestProfileDirectory "input" "libolecf"
